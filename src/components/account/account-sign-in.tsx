  ...
  return (
    <div className="mx-4 rounded-2xl bg-surface px-6 py-16 text-center sm:mx-6 lg:mx-8">
      ...
      <Link
        ...
        className="mt-6 inline-flex h-11 items-center justify-center rounded-full bg-cta px-6 text-sm font-semibold text-cta-foreground transition-colors hover:bg-cta-hover"
      >
        Sign in
      </Link>
    </div>
