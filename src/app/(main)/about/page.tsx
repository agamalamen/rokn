  ...
  return (
    <div className="py-6">
      ...
      <div className="mt-10 px-4 sm:px-6 lg:px-8">
        <Link
          href="/products"
          className="inline-flex h-11 items-center justify-center rounded-full bg-cta px-6 text-sm font-semibold text-cta-foreground transition-colors hover:bg-cta-hover"
        >
          Start shopping
        </Link>
      </div>
